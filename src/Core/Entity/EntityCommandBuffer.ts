...
export class EntityCommandBuffer {
    ...
    public AddComponent<T extends ComponentCtor>(entityId: EntityId, component: T, value: T extends Component<any> ? ComponentValue<T> : undefined = undefined): this {
        this._addComponent.ids.push(entityId);
        this._addComponent.components.push(component);
        if(typeof value !== "undefined") this._addComponent.values.push(value);
        return this;
    }
